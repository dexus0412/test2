main()
{
	...
	return;
	if (getDvarInt("promod_mc_rs_every_round") ) setDvar("mc_current_msg", "0");
	if (getDvar("mc_current_msg") == "") setDvar("mc_current_msg", "0");
	Run_Messages();
}
	...
	
	{
		...
		
		{
			...
			
			{
				...
				if (message == "<*nextmap*>") message = Get_Next_Map();
...
Get_Next_Map()
{
	...
	nextmap = "^2Next Map^7: ^0" + map + " ^1(" + gt + ")";
	return nextmap;
}
